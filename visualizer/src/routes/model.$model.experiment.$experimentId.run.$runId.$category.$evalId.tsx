...
export const Route = createFileRoute(
  ...
  component: ModelEvalDetailsPage,
});

function ModelEvalDetailsPage() {
  const { model, experimentId, runId, category, evalId } = useParams({
    from: "/model/$model/experiment/$experimentId/run/$runId/$category/$evalId",
  });
  const { tab, file } = useSearch({
    from: "/model/$model/experiment/$experimentId/run/$runId/$category/$evalId",
  });
  ...
  const routePath =
    "/model/$model/experiment/$experimentId/run/$runId/$category/$evalId" as const;
...
function TabButton({
  ...
  return (
    <Link
      ...
      params={{ model, experimentId, runId, category, evalId }}
      search={{ tab }}
