...
export const Route = createFileRoute(
  ...
  component: ModelCategoryOverviewPage,
});

function ModelCategoryOverviewPage() {
  const { model, experimentId, runId, category } = useParams({
    from: "/model/$model/experiment/$experimentId/run/$runId/$category/",
  });
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card">
          <div className="card-header">
            📋 Evaluations in {formatCategoryName(category)}
          </div>
